...
public class UserInteraction {
	...
	public static void main(String[] args)
			throws ClassNotFoundException, NoSuchFieldException, SecurityException, ParseException, IOException {
	 ...
	 * @throws IOException
	 */
	public void selectProgram(String inputvalue)
			throws ParseException, ClassNotFoundException, NoSuchFieldException, SecurityException, IOException {
		try {
	...
	private void Multicommand(String inputvalue) throws InvalidInputException, ClassNotFoundException,
			NoSuchFieldException, SecurityException, ParseException, IOException {
		...
		if (inputvalue.equals("1")) {
			...
			System.out.println("Enter first argument must be 1 then enter numbers which you want to add");
	 ...
	 * @throws IOException
	 */
	private void StringManipulation(String inputvalue) throws InvalidInputException, ClassNotFoundException,
			NoSuchFieldException, SecurityException, ParseException, IOException {

		Scanner s = new Scanner(System.in);
		System.out.println("enter your choice 1 or 2");
		System.out.println("1:Enter the string to reverse");
		System.out.println("2:enter the string to count the number of uppercase , lower case letter");
		inputvalue = s.nextLine();
		StringOperation SM = new StringOperation();

		if (inputvalue.equals("1")) {
			System.out.println("Enter the string to reverse and 1st argument must be 1: ");
			...
			System.out.println(
					"Enter the string to count the number of uppercase , lower case letter and 1st argument must be 2: ");
			String[] numberval = new String[2];
	 ...
	 * @throws IOException
	 */
	private void StringOperation(String inputvalue) throws InvalidInputException, ClassNotFoundException,
			NoSuchFieldException, SecurityException, ParseException, IOException {
	...
	public void dateFormate(String inputvalue) throws InvalidInputException, ClassNotFoundException,
			NoSuchFieldException, SecurityException, ParseException, IOException {
	 ...
	 * @throws IOException
	 */
	private void DateDiffernce(String inputvalue) throws InvalidInputException, ParseException, ClassNotFoundException,
	 ...
	 * @throws Exception
	 */
	private void AddDate(String inputvalue) throws Exception, InvalidInputException {
		Scanner s = new Scanner(System.in);
	...
	private void classInfo(String inputscan) throws InvalidInputException, NoSuchFieldException, SecurityException,
	 ...
	 * @throws IOException
	 */
	private void frequency(String inputscan) throws ClassNotFoundException, InvalidInputException, NoSuchFieldException,
	 ...
	 * @throws ParseException
	 */
	private void EmployeeSearch(String inputvalue) throws InvalidInputException, IOException, ClassNotFoundException,
	 ...
	 * @throws ClassNotFoundException
	 */
	private void EmployeeSorting(String inputvalue) throws IOException, InvalidInputException, ClassNotFoundException,
			NoSuchFieldException, SecurityException, ParseException {
		Scanner s = new Scanner(System.in);
	...
	void printmessage() throws ClassNotFoundException, NoSuchFieldException, InvalidInputException, SecurityException,
